<template>
  <div id="main" ref="main" style="width: 100%; height: 285px;"></div>
</template>

<script setup>
import {onMounted, ref, onUnmounted, onBeforeUnmount} from 'vue'
import * as echarts from 'echarts/core'
import {BarChart, PictorialBarChart, PieChart, LineChart} from 'echarts/charts'
...
const main = ref(null)
const init = () => {
  let chartDom1 = main.value
  let myChart1 = echarts.init(chartDom1, '#021536')
  let option1
