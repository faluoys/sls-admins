    ...
    <div class="right">
      ...
      <div class="bottom">
        ...
        >
          ...
          <el-table-column align="center" width="60" prop="uId" label="ID"/>
          <el-table-column align="center" prop="uName" label="用户名称"/>
          <el-table-column align="center" prop="dName" label="用户部门"/>
          <el-table-column align="center" prop="rName" label="用户角色"/>
          <el-table-column align="center" prop="uTel" label="联系方式"/>
          <el-table-column align="center" prop="uPower" label="用户权限"/>
