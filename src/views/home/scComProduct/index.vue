        ...
        <div class="right">
            ...
            <div class="bottom">
                <el-table :data="tableData"
                    ...
                    <el-table-column label="产品图片" prop="pImg">
                    ...
                    <el-table-column label="产品名称" prop="pName"/>
                    <el-table-column label="产品标识" prop="pFalg"/>
                    <el-table-column label="产品信息" prop="pInfo"/>
                    <el-table-column label="公司Id" prop="scId"/>
                    <el-table-column label="产品价格" prop="pPrice"/>
