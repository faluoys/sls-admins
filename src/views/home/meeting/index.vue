    ...
    <div class="right">
      ...
      <div class="bottom">
        <el-table :data="tableData"
          ...
          <el-table-column align="center" fixed width="60" label="序号">
            <template #default="{$index}">
              {{ $index + 1 }}
            </template>
          </el-table-column>
          <el-table-column align="center" fixed prop="oName" label="会议名称"/>
          <el-table-column align="center" width="60" prop="oId" label="ID"/>
          <el-table-column align="center" prop="oNum" label="会议室"/>
          <el-table-column align="center" prop="oTel" label="会议号码"/>
          <el-table-column align="center" prop="oInfo" label="会议介绍"/>
