        ...
        <div class="right">
            ...
            <div class="bottom">
                <el-table :data="tableData"
                    ...
                    <el-table-column label="Id" prop="scId"/>
                    <el-table-column label="公司Logo" prop="scLogo">
                    ...
                    <el-table-column label="名称" prop="scName"/>
                    <el-table-column label="负责人" prop="scMan"/>
                    <el-table-column label="电话" prop="scTel"/>
                    <el-table-column label="网址" prop="scWebUrl"/>

                    <el-table-column label="公司产品" width="150">
                        <template #default="scope">
                            <el-button
                                plain
                                color="#626aef"
